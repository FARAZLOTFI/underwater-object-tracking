...
IMAGE_SIZE = (416, 416)
BB_AREA_THRESHOLD = (IMAGE_SIZE[0]/3.5)*(IMAGE_SIZE[1]/3.5)
BB_AREA_MAX = 100*(IMAGE_SIZE[0]/2.9)*(IMAGE_SIZE[1]/2.9) # SAFETY DISTANCE!!
...
IMAGE_ARTIFICAL_BOUNDARIES = 0.8
# when using episodic learning
MAX_EPISODE = 100
