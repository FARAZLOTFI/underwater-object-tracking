...
class PID_controller:
    def __init__(self, reference_values = None, single_object_tracking = True):
        ...
        self.area_controller_gains = [-5.0,0.0,0] #[-8,-2,0] sim - another option for real
        self.x_controller_gains = [2.5,4,0]#[0.9,0.1,0]#[2,1,0] sim - 2,5,4 in real another option for real [0.9,0.1,0.0]
        self.y_controller_gains = [2,0.1,0]#[0.13,2,0]
    ...
    def output_update(self, current_observation, target_x, target_y, area_target):
        ...
        print('PID controller input (current obs, target): ',current_observation[2] , area_target)
